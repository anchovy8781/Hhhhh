...
const BASES: BaseRow[] = [
  ...
  ["aluminum-cast", "주조 알루미늄 (농형 바)", 3.4e-8, 0.0042, 2700, 0.25, 660, 0xa8b0b8, "회전자 케이지 다이캐스팅", "유도전동기 농형을 통째로 주조합니다. 순알루미늄보다 저항이 큽니다."],
  ["copper-cast", "주조 구리 (농형 바)", 2.0e-8, 0.0039, 8900, 1.6, 1085, 0xbf7c3f, "고효율 회전자 케이지", "구리 다이캐스팅 케이지는 효율을 2~3% 올립니다. 주조 온도가 높아 비쌉니다."],
  ["bronze", "인청동", 1.1e-7, 0.002, 8800, 1.5, 950, 0xa8844a, "스프링 접점 내마모", "탄성이 필요한 접점·브러시 홀더용입니다."],
  ["nichrome", "니크롬", 1.1e-6, 0.0001, 8400, 4, 1400, 0x8d8d8d, "발열체 저항기", "저항이 매우 크고 온도계수가 거의 0이라 발열체와 정밀 저항에 씁니다."],
  ["manganin", "망가닌", 4.8e-7, 0.00001, 8400, 12, 1020, 0x9a9a9a, "분류기 정밀저항", "온도계수가 거의 0이라 전류 측정용 분류기(shunt)에 씁니다."],
];
