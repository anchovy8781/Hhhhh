...
export const bldc: DeviceDefinition = {
  ...
  params: [
    ...
    { kind: "number", key: "switchDrop", label: "인버터 전압강하", unit: "V", min: 0, max: 4, step: 0.05, default: 0.7, group: "운전", hint: "MOSFET 두 개를 지나는 도통 손실. 브러시보다 훨씬 작습니다.", advanced: true },
    insulationClassParam(),
    ...environmentParams(),
  ],
  simulate,
...
function recommend(values: ParamValues): Recommendation[] {
  ...
  const drop = num(values, "switchDrop");
