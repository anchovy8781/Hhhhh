...
export const solenoid: DeviceDefinition = {
  ...
  params: [
    ...
    { kind: "number", key: "bobbinOd", label: "코일 외경", unit: "mm", min: 8, max: 150, step: 1, default: 30, group: "치수", advanced: true },
    { kind: "number", key: "coilLength", label: "코일 길이", unit: "mm", min: 5, max: 200, step: 1, default: 35, group: "치수" },
    { kind: "number", key: "shell", label: "외부 요크 두께", unit: "mm", min: 0, max: 20, step: 0.5, default: 4, group: "치수", hint: "자속의 귀환 경로입니다. 0이면 자속이 공기로 새어 힘이 급감합니다.", advanced: true },
